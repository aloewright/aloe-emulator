...
impl AltScreenFilter {
    ...
    fn process<'a>(&mut self, data: &'a str) -> Cow<'a, str> {
        ...
        // Optimization: if we are not in alt screen and there are no trigger sequences, return borrowed
        // This avoids allocation for the vast majority of terminal output
