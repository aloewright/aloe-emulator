<template>
  <div
    class="live-preview-panel h-full flex flex-col bg-bg-tertiary border-l border-gray-700"
  >
    <!-- Header -->
    <div
      class="flex items-center justify-between px-4 py-2 border-b border-gray-700 bg-bg-secondary"
    >
    ...
    <!-- Preview Container -->
    <div
      class="flex-1 flex items-center justify-center p-4 bg-gray-900/50 overflow-hidden"
    >
      <div
    ...
    <!-- URL Bar -->
    <div
      class="px-4 py-2 border-t border-gray-700 bg-bg-secondary flex items-center gap-2"
    >
